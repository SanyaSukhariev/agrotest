  ...
  render() {
    ...
    return (
        ...
        <div className={classes.slide}>
          <img src="https://svitagro.com.ua/wp-content/uploads/2018/05/shutterstock_445559818.jpg" alt="Slide 1" />
        </div>
        <div className={classes.slide}>
          <img src="https://svitagro.com.ua/wp-content/uploads/2018/05/shutterstock_325466795.jpg" alt="Slide 2" />
        </div>
        <div className={classes.slide}>
            <img src="https://svitagro.com.ua/wp-content/uploads/2021/05/friends-1149841-scaled.jpg" alt="Slide 3" />
        </div>
        </Slider>
      </div>
        ...
        <div >
            ...
            <p>
            Основною сферою діяльності компанії є продаж <br />сільськогосподарським підприємствам таких товарів як:
            </p>
